...
$fields = ['branch_id','record_date','full_name','national_id','phone_primary','proximity_relation','phone_secondary','birth_date','address','patient_rating','patient_rating_comment','patient_status','social_security','report_status','service_type','service_type_id','source_id','source_detail','anamnesis','notes'];
...
<div class="icon-form-row"><label class="icon-form-label">Telefon 1</label><div><div class="merged-input"><span class="merged-icon">⌕</span><input id="phone_primary" name="phone_primary" value="<?=e($patient['phone_primary'])?>"></div><button id="proximity-toggle" class="proximity-toggle" type="button" <?=trim($patient['phone_primary'])===''?'hidden':''?>>Yakınlık Derecesi Ekle</button></div></div>
<div id="proximity-row" class="icon-form-row proximity-row <?=trim($patient['phone_primary'])===''||trim($patient['proximity_relation'])===''?'is-hidden':''?>"><label class="icon-form-label">Yakınlık Derecesi</label><div class="merged-input"><span class="merged-icon">♧</span><input id="proximity_relation" name="proximity_relation" value="<?=e($patient['proximity_relation'])?>"></div></div>
