...
const initializeSalesScreen=()=>{
  ...
  const salesTitle=detailsModal?.querySelector('#sales-details-title'),salesGrandTotal=(()=>{if(!salesTitle)return null;let output=salesTitle.querySelector('#sales-grand-total');if(output)return output;output=document.createElement('span');output.id='sales-grand-total';output.textContent='Toplam Satış: 0,00 ₺';salesTitle.prepend(output);salesTitle.style.cssText+=';display:flex;align-items:center;gap:18px';return output;})();
