  ...
  <section class="vuexy-form-card stock-list-card">
    ...
    <div class="table-responsive">
      <table class="stock-list-table">
        <thead><tr><th>Stok Kodu</th><th>Stok Tipi</th><th>Stok Adı</th><th>Marka / Model</th><th>Cihaz Tipi</th><th>Güç Kullanımı</th><th>Renk</th><th>Görsel</th><th>Stok Miktarı</th><th>Kritik Stok</th><th>Satış Fiyatı</th><th>İşlemler</th></tr></thead>
        <tbody>
        <?php if (!$stocks): ?>
...
<style>.stock-search select{height:40px;min-width:190px;padding:0 12px;border:1px solid #d5d3de;border-radius:6px;background:#fff;font:inherit;color:#2f2b3d}@media(max-width:720px){.stock-search{align-items:stretch;flex-direction:column}.stock-search select{width:100%}}</style>
<?php patient_footer(); ?>
