...
$tables=[
 ...
 'patients'=>['id','import_order','branch_id','record_date','full_name','national_id','phone_primary','phone_secondary','birth_date','address','social_security','report_info','service_type','source_primary','source_marketing','source_detail','anamnesis','notes','approval','considering','rejected','staff_cansu','staff_busra','staff_belma','created_at','updated_at']
];
