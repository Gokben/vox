...
?>
<style>
.unit-visits-page{width:100%;max-width:1000px;margin:0 auto;padding:46px 20px 48px}.unit-visits-card{background:var(--card);border:1px solid var(--line);border-radius:10px;box-shadow:0 3px 12px #1e283c0f;overflow:hidden}.unit-visits-head{display:flex;align-items:center;justify-content:space-between;padding:22px 24px;border-bottom:1px solid var(--line)}.unit-visits-head h2{margin:0;font-size:21px}.unit-visits-head p{margin:5px 0 0;color:var(--muted)}.unit-visits-form{display:grid;grid-template-columns:150px minmax(0,1fr);gap:14px 0;padding:22px 24px;border-bottom:1px solid var(--line)}.unit-visits-form label{padding:11px 15px 0 0}.unit-visits-form input,.unit-visits-form textarea{width:100%;border:1px solid #d5d3de;border-radius:6px;padding:9px 12px;background:var(--card);color:var(--text);font:inherit}.unit-visits-form textarea{min-height:84px;resize:vertical}.unit-visits-actions{grid-column:2;display:flex;gap:12px;margin-top:4px}.unit-visits-table{width:100%;border-collapse:collapse}.unit-visits-table th,.unit-visits-table td{padding:14px 24px;border-bottom:1px solid var(--line);text-align:left}.unit-visits-table th{font-size:12px;color:var(--muted)}.unit-visits-empty{padding:32px 24px;color:var(--muted)}.unit-visits-alert{margin:18px 24px 0;padding:12px;border-radius:6px;background:#fde8e8;color:#a62c2c}.unit-visits-back{color:#16883d;text-decoration:none;font-weight:700}@media(max-width:720px){.unit-visits-page{padding:20px 12px 30px}.unit-visits-head{padding:18px}.unit-visits-form{grid-template-columns:1fr;padding:18px}.unit-visits-form label{padding:0}.unit-visits-actions{grid-column:auto}.unit-visits-table th,.unit-visits-table td{padding:12px}.unit-visits-table{font-size:13px}}
</style>
<main class="patient-container unit-visits-page">
  <section class="unit-visits-card">
    ...
    <form method="post" class="unit-visits-form">
