...
<main class="patient-container personnel-page">
  ...
  <details class="vuexy-form-card definition-accordion"<?=((int)$edit['id'] || $error !== '') ? ' open' : ''?>>
    ...
    <form method="post" action="<?= url('service-types.php' . ((int)$edit['id'] ? '?edit=' . (int)$edit['id'] . '&mode=edit' : '')) ?>" class="personnel-form">
      ...
      <div class="personnel-actions"><button><?= (int)$edit['id'] ? 'Güncelle' : 'Kaydet' ?></button><?php if ((int)$edit['id']): ?> <a class="edit-personnel" href="<?=url('service-types.php')?>">İptal</a><?php endif; ?></div>
    </form>
  </details>
