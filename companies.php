...
.company-actions{align-items:center}.company-actions>a,.company-actions>form>button{box-sizing:border-box!important;flex:0 0 36px!important;width:36px!important;height:36px!important;min-width:36px!important;min-height:36px!important;max-width:36px!important;max-height:36px!important;padding:0!important;line-height:1!important}.company-actions>a[href*="patients.php"]{background:#f3a64a!important}.company-actions>a .icon-base,.company-actions>form>button .icon-base{font-size:18px!important}
</style>
