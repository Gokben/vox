...
foreach ([[6000,2,64.7059,4235.29],[5000,1,64.7058,1764.71],[31500,8,55,113400],[19500,2,40,23400]] as [$cost,$qty,$discount,$expected]) {eval($m[0]);if(abs($total-$expected)>.00001) throw new Exception('Incorrect persisted total');}
